...
echo '<td class="nav-item"><a class="nav-link link-dark" href=index.php?product=1>Tout les compte</a></td><br>';
?> </tr></div></section>
</table>
<?php
