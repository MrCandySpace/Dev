...
<form class="row flex-column align-items-center">
    ...
    <div class="form-floating mb-2 col-8 col-md-6">
        <input type="email" class="form-control" id="floatingInputValue" placeholder="nomprenom@mail.com">
    ...
    <button type="button" class="btn btn-outline-primary col-5 col-md-1">Envoyer</button>
